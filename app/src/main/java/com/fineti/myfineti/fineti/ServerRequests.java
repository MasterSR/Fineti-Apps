...
public class ServerRequests {
    ...
    public static final String SERVER_ADDRESS = "http://fineti.net23.net/";
    ...
    public class StoreUserDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            dataToSend.add(new BasicNameValuePair("designation", user.designation));
            dataToSend.add(new BasicNameValuePair("state", user.state));
            dataToSend.add(new BasicNameValuePair("region", user.region));
            dataToSend.add(new BasicNameValuePair("report_to", user.report_to));
        ...
        protected User doInBackground(Void... params) {
            ...
            try {
                ...
                if (jObject.length() != 0){
                    ...
                    String region = jObject.getString("region");
                    String report_to = jObject.getString("report_to");

                    returnedUser = new User(name, mobile, user.username, user.password,designation,state,region,report_to,user.status);
                }
